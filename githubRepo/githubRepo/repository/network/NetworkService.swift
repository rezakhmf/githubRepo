...
open class NetworkService: NSObject, URLSessionDelegate {
    ...
    public enum Authorization {
        ...
        var header: String {
            ...
            case .token(accessToken: let accessToken):
    ...
    public struct Keys {
        ...
        static let errorDomain = "Networking"
    ...
    /// Call this before releasing the NetworkService instance to prevent retain cycles.
